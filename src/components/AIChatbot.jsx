            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        className="flex flex-col h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-[1.5rem] bg-gradient-to-br from-indigo-500 via-purple-600 to-blue-600 text-white shadow-2xl shadow-indigo-500/30 ring-1 ring-white/20 transition-all hover:scale-105 active:scale-95 group"
                    >
                        ...
                        <div className="relative flex items-center justify-center">
                            <Sparkles className="h-4 w-4 sm:h-4 sm:w-4 absolute opacity-0 group-hover:opacity-100 group-hover:scale-125 transition-all duration-500" />
                            <MessageSquare className="h-5 w-5 sm:h-5 sm:w-5 group-hover:opacity-0 transition-all duration-500" />
                        </div>
                        <span className="font-extrabold tracking-widest uppercase text-[7px] sm:text-[7px] hidden sm:block text-center leading-[1.2] mt-1">AI<br/>Ассистент</span>
