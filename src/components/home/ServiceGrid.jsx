...
export function ServiceGrid() {
    ...
    return (
        <div className="flex justify-start md:justify-center gap-4 md:gap-10 mb-12 md:mb-16 pb-4 overflow-x-auto no-scrollbar snap-x snap-mandatory px-4 md:px-0 -mx-4 md:mx-0">
