...
export function ServiceGrid() {
    ...
    return (
        <div className="flex justify-center gap-6 md:gap-10 mb-12 md:mb-16">
            ...
            {/* Services (Услуги) */}
            <Link to="/marketplaces?category=Услуги" className="flex flex-col items-center group cursor-pointer transition-transform hover:scale-105 active:scale-95">
                <div className="w-24 h-24 md:w-32 md:h-32 bg-card rounded-3xl overflow-hidden shadow-xl shadow-purple-500/10 flex items-center justify-center group-hover:shadow-purple-500/30 transition-all border border-border relative">
                    <img
            ...
            {/* Mortgage (Ипотека) */}
            <Link to="/mortgage" className="flex flex-col items-center group cursor-pointer transition-transform hover:scale-105 active:scale-95">
                <div className="w-24 h-24 md:w-32 md:h-32 bg-card rounded-3xl overflow-hidden shadow-xl shadow-amber-500/10 flex items-center justify-center group-hover:shadow-amber-500/30 transition-all border border-border relative">
                    <img
