    ...
    return (
        <div className="bg-[#191624] rounded-[32px] p-8 shadow-2xl border border-white/5 space-y-8 sticky top-24" id="contact-sidebar">
            ...
            <div className="space-y-4 pt-4">
                <MagneticButton 
                    onClick={() => window.location.href = `tel:${marketplace.phone || '+998'}`}
                    className="w-full bg-indigo-600 hover:bg-indigo-500 text-white h-16 rounded-2xl font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-3 transition-all shadow-lg shadow-indigo-600/20 active:scale-95 italic"
                >
                    <Phone className="h-5 w-5" /> Позвонить продавцу
                </MagneticButton>
