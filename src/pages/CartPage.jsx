                                            ...
                                            <div className="font-bold">
                                                {viewMode === 'FULL' ? (
                                                    ...
                                                    <span className="text-emerald-600">
                                                        {(Math.ceil((item.price * item.quantity) / months)).toLocaleString()} Sum <span className="text-xs text-slate-500 font-bold">x {months} мес</span>
                                                    </span>
                                                )}
                                            </div>
                        ...
                        <div className="rounded-xl border bg-card p-6 sticky top-24 shadow-sm">
                            ...
                            <div className="space-y-3 mb-6 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-slate-900">{cartTotal.toLocaleString()} Sum</span>
                                </div>
                                {discountAmount > 0 && (
                                    <div className="flex justify-between text-emerald-600">
                                        <span>Скидка ({settings.discount_percent}%)</span>
                                        <span>-{discountAmount.toLocaleString()} Sum</span>
                                    </div>
                                )}
                                ...
                                <div className="border-t pt-3 mt-3">
                                    <div className="flex justify-between items-end">
                                        ...
                                        <div className="text-right">
                                            <div className="font-bold text-xl text-slate-900">{finalTotal.toLocaleString()} Sum</div>
                                            {viewMode === 'INSTALLMENT' && (
                                                <div className="text-sm text-emerald-600 font-medium">
                                                    или {monthlyTotal.toLocaleString()} Sum / мес
                                                </div>
                                            )}
                                        </div>
                                    </div>
