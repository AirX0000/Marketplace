                        ...
                        <div className="rounded-xl border bg-card p-6 shadow-sm">
                            ...
                            <div className="space-y-3 mb-6 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-slate-900">{subtotal.toLocaleString()} Sum</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-slate-700">Доставка</span>
                                    <span className="font-medium text-slate-900">{SHIPPING_COST === 0 ? <span className="text-green-600 font-semibold">Бесплатно</span> : `${SHIPPING_COST.toLocaleString()} Sum`}</span>
                                </div>
                                {discountAmount > 0 && (
                                ...
                                <div className="border-t pt-3 mt-3">
                                    <div className="flex justify-between items-end">
                                        ...
                                        <div className="text-right">
                                            <div className="font-bold text-xl text-slate-900">{total.toLocaleString()} Sum</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
