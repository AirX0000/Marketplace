                            ...
                            <div className="bg-slate-50 p-4 flex flex-wrap gap-4 items-center justify-between text-sm border-b border-slate-100">
                                <div className="flex flex-wrap gap-6">
                                    ...
                                    <div>
                                        ...
                                        <span className="font-bold text-primary">{order.total.toLocaleString()} Sum</span>
                                    </div>
                                    <div>
                                    ...
                                    <div key={item.id} className="flex gap-4 items-center">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="text-sm text-slate-500 flex items-center gap-2 mt-1">
                                                ...
                                                <span>&bull;</span>
                                                <span>{item.price.toLocaleString()} Sum / шт</span>
                                            </div>
                                        </div>
                                        <div className="font-bold text-slate-900">
                                            {(item.total || (item.price * (item.quantity || 1))).toLocaleString()} Sum
