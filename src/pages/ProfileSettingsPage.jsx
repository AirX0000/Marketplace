        ...
        <div className="container max-w-4xl py-10 px-4 md:px-6 animate-in fade-in duration-500">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1 space-y-6">
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm flex flex-col items-center text-center">
                        ...
                        <label className="flex items-center gap-1.5 text-xs text-blue-600 hover:text-blue-800 cursor-pointer font-semibold mb-3 transition-colors">
                            {uploading ? (
                                <span className="flex items-center gap-1"><div className="animate-spin rounded-full h-3 w-3 border-b border-blue-600"></div> Загрузка...</span>
                            ) : (
                                <><Camera className="h-3.5 w-3.5" /> Изменить фото</>
                            )}
                            <input type="file" className="hidden" accept="image/*" onChange={handleFileChange} disabled={uploading} />
                        </label>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="flex h-11 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 pl-10 text-sm text-slate-900 focus:bg-white focus:border-primary transition-all outline-none"
                        ...
                        <form onSubmit={handleAddressSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full rounded-lg border border-slate-300 p-3 text-slate-900 focus:border-primary outline-none resize-none"
                                />
                            </div>
            ...
            {topUpModalOpen && (
                <TopUpModal
                    ...
                    onSuccess={(newBalance) => setProfile(prev => ({ ...prev, balance: newBalance }))}
                />
            )}
        </div>
    );
