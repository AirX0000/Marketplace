...
export function SuperAdminDashboard() {
    ...
    const cards = [
        { title: "Общий Доход", value: `${(stats?.totalRevenue || 0).toLocaleString()} Sum`, icon: DollarSign, color: "text-blue-600", bg: "bg-blue-100" },
        { title: "Прибыль Платформы (10%)", value: `${(stats?.totalCommission || 0).toLocaleString()} Sum`, icon: TrendingUp, color: "text-blue-600 600", bg: "bg-blue-600/100" },
