            ...
            <div className="w-full lg:w-1/2 h-full overflow-y-auto flex items-center justify-center p-8 sm:p-12 lg:p-24 relative">
                ...
                <div className="w-full max-w-[400px] space-y-10">
                    <div className="space-y-4">
                        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{t('auth.welcome_back')}</h1>
                        <p className="text-slate-500 dark:text-slate-400">{t('auth.enter_credentials')}</p>
                    </div>
