...
export const MOCK_POSTS = [
    ...
    {
        id: 3,
        title: "Как проверить историю автомобиля перед покупкой",
        excerpt: "Полное руководство по проверке авто: от баз ГАИ до коммерческих отчетов. Узнайте, как не купить машину со скрученным пробегом или после серьезного ДТП.",
        category: "Авто",
        author: "Тимур Расулов",
        date: "05 Фев 2024",
        readTime: "6 мин",
        image: "https://images.unsplash.com/photo-1550305080-4cf02b8fbb15?auto=format&fit=crop&q=80&w=2070",
        content: `
            <p className="mb-4">Проверка истории — ключевой этап при покупке авто с пробегом. Даже идеальный внешний вид может скрывать темное прошлое.</p>
            
            <h2 className="text-2xl font-bold mb-3 mt-6">Официальные базы</h2>
            <p className="mb-4">В первую очередь проверяйте машину по VIN-коду в официальных базах СЦБДД. Это бесплатно и покажет наличие запретов на регистрацию.</p>
        `
    }
];
