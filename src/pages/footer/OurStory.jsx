                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        ...
                        <div className="flex flex-col justify-center space-y-4">
                            ...
                            <p className="text-slate-600">
                                AURA MARKET начался с простой идеи: связывать бизнесы не должно быть сложно. В 2024 году наши основатели увидели пробел на рынке для единой платформы, где разработчики и компании могли бы легко находить, покупать и управлять цифровыми интеграциями.
                            </p>
                        </div>
                    </div>
