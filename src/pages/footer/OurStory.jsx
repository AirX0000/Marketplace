                ...
                <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
                    ...
                    <div className="grid sm:grid-cols-3 gap-6 mt-12 text-center">
                        <div className="p-6 border border-slate-200 rounded-xl bg-card">
                            ...
                            <div className="text-sm font-medium text-slate-600 dark:text-slate-300">Активных Пользователей</div>
                        </div>
                        <div className="p-6 border border-slate-200 rounded-xl bg-card">
                            <div className="text-4xl font-black text-emerald-600 mb-2">500+</div>
                            <div className="text-sm font-medium text-slate-600 dark:text-slate-300">Магазинов</div>
                        </div>
                        <div className="p-6 border border-slate-200 rounded-xl bg-card">
                            <div className="text-4xl font-black text-emerald-600 mb-2">24/7</div>
                            <div className="text-sm font-medium text-slate-600 dark:text-slate-300">Поддержка</div>
                        </div>
                    </div>
                </div>
            </div>
