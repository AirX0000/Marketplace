    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 pb-20">
            ...
            <div className="max-w-6xl mx-auto px-4 -mt-6 relative z-10">
                ...
                <div className="mt-12 bg-white dark:bg-slate-800 rounded-[32px] p-8 md:p-12 shadow-xl border border-slate-100 dark:border-slate-700">
                    <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-6">
                        {isRu ? 'Оригинальная сводка банков' : 'Banklardan asl ma\'lumot'}
                    </h3>
                    <div className="prose prose-slate dark:prose-invert max-w-none text-sm md:text-base whitespace-pre-wrap text-slate-600 dark:text-slate-300 font-medium">
{`🏠 БИРЛАМЧИ ВА ИККИЛАМЧИ БОЗОР УЧУН ИПОТЕКА КРЕДИТЛАРИ
...
◦  Фоизи - 17%
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 15% дан бошланади
◦  Миқдори - 420 млн сўмгача 

• Иккиламчи
◦  Фоизи - 25%
◦  Муддати - 15 йил
◦  Бошланғич тўлов - 25%
◦  Миқдори - 800 млн сўмгача 
...
◦  Фоизи - 26%
◦  Муддати - 15 йил
◦  Бошланғич тўлов - 26% дан бошланади
◦  Миқдори - 1 млрд 318 млн 400 минг сўмгача 

🏦 БРБ
• Бирламчи
◦  Фоизи - 17,5%дан 18%гача
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 15%дан 25%гача
◦  Миқдори - 420 млн сўмгача 

• Иккиламчи
◦  Фоизи - 24,5%дан 26%гача
◦  Муддати - 15 йилгача
◦  Бошланғич тўлов - 20% дан бошланади
◦  Миқдори - 2 млрд 60 млн сўмгача 

🏦 Гарант банк
• Иккиламчи
◦  Фоизи - 26%дан 28%гача
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 25%дан 45%гача
◦  Миқдори - 420 млн сўмгача 

🏦 Тенге Банк
• Бирламчи
◦  Фоизи - 23,9%дан 24,9%гача
◦  Муддати - 15 йилгача
◦  Бошланғич тўлов - 25% дан бошланади
◦  Миқдори - 820 млн сўмгача 

• Иккиламчи
◦  Фоизи - 24,6%
◦  Муддати - 10 йилгача
◦  Бошланғич тўлов - 28% дан бошланади
◦  Миқдори - 820 млн сўмгача 

🏦 Ипак Йули Банк
• Бирламчи
◦  Фоизи - 16,5%дан 17,5%гача
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 5%дан 15%гача
◦  Миқдори - 420 млн сўмгача 

• Иккиламчи
◦  Фоизи - 23%дан 24,9%гача
◦  Муддати - 15 йил
◦  Бошланғич тўлов - 25%дан 50%гача
◦  Миқдори - 1,5 млрд сўмгача 
...
• Иккиламчи
◦  Фоизи - 24%дан 26%гача
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 25% дан бошланади
◦  Миқдори - 1 млрд 648 млн сўмгача 

🏦 Ўзмиллийбанк
• Бирламчи
◦  Фоизи - 17% дан 17,5% гача
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 15% дан 40% гача
◦  Миқдори - 420 млн сўмгача 

• Иккиламчи
◦  Фоизи - 21,5% дан 22% гача
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 25% дан бошланади
◦  Миқдори - 800 млн сўмгача 
...
🏦 Туронбанк
• Бирламчи
◦  Фоизи - 17% дан 18% гача
◦  Муддати - 20 йилгача
◦  Бошланғич тўлов - 15% дан 70% гача
◦  Миқдори - 420 млн сўмгача 

• Иккиламчи
◦  Фоизи - 26%
◦  Муддати - 10 йилгача
◦  Бошланғич тўлов - 20% дан 30% гача
◦  Миқдори - 1 млрд 648 млн сўмгача 
